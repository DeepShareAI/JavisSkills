<!--
Source: /home/workspace/openclaw-users/user_31VcZbTLe6NApS2tqghvxE5FnQR/workspace/skills/english-daily/SKILL.md
Pulled: 2026-05-26
Pinned exemplar — do not edit to match upstream changes; bump deliberately when the periodic-push template evolves.
-->
...
## 推送设置（Agent-Driven Cron）

When user requests daily push (e.g., '每天2:35推送英语到discord'):

### Step 1: Save preferences
```bash
node scripts/push-toggle.js on <userId> --morning <HH:MM> --channel <channel>
```
...
Tell the user: push is set up for <time> on <channel>, and will also appear in their iOS agent chat under /english-daily.
